...
namespace MonsterJobs.FullStackPostions
{
    class Program
    {
        ...
        private static TopicClient JobTopicClient;

        static void Main(string[] args)
        {
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Press any key to continue to list DBA Positions! Wait for admin console to load");
            Console.ReadKey();
        ...
        private static void ReceiveFromSubscriptions(string topicPath)
        {
            ...
            SubscriptionClient subClient =
                Factory.CreateSubscriptionClient(topicPath, JobType.DBA.ToString());
